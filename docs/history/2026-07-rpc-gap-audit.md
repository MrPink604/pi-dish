# Historical RPC feature-gap audit (July 2026)

This is the original backlog, retained as a historical snapshot. Many gaps
below have since shipped. Use [the current backlog](../../BACKLOG.md) for work
priorities and [README](../../README.md) for supported behavior.
