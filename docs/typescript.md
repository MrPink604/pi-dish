...
The current gate covers `src/core`, `src/browser`, checked `lib/cron.js`, the
exact edge/native source lists and named fixtures, not remaining JS implementations.
