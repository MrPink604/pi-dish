export { createHostTransport, createSessionApi, setSessionModel, setSessionThinking, renameSession, sendJson, withFetchTimeout, modelCatalogUrl, ApiHttpError } from './api-client';
...
export { decodeCacheLifetimes, cacheLifetimeStatus, cacheLifetimesHtml, formatGap } from './cache-lifetimes';
...
export { renderSidebar, harnessBadgeInnerHtml, renderHarnessBadge } from './sidebar-render';
