...
import { createMathExtensions as createSharedMathExtensions } from '../core/helper-markdown';
...
export function createMathExtensions(katexLib?: KatexRenderer | null) {
  return createSharedMathExtensions(() => katexLib || (typeof katex !== 'undefined' ? katex : null));
}
