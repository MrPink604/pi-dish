// Generated tool from test/core-build.test.ts; edit that source and run npm run build:tools.
"use strict";
...
test('core build detects stale runtime/declarations and never repairs them in check mode', () => {
    ...
    try {
        ...
        const run = (...args) => (0, node_child_process_1.spawnSync)(process.execPath, ['scripts/build-core.js', ...args], {
