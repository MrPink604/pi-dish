...
import { projectSkillCoverage } from '../lib/skills.js';

type SkillRead = Parameters<typeof projectSkillCoverage>[2][number];

const read = (patch: Partial<SkillRead> = {}): SkillRead => ({
