...
const usage: UiScenario = async ({ desktop, check, SESSION_ID }) => {
  ...
  check(await desktop.evaluate(() => fixtureElement(document.querySelector('.main'), "document.querySelector('.main')").classList.contains('usage-open')),
  ...
  check(await desktop.evaluate(() => fixtureElement(document.querySelector('.usage-day-detail'), "document.querySelector('.usage-day-detail')").textContent.includes('smoke-model')),
    "clicking a bar opens that day's per-model detail");
  check(await desktop.evaluate(() => fixtureElement(document.querySelector('.usage-day-detail'), "document.querySelector('.usage-day-detail')").textContent.includes('% hit')),
