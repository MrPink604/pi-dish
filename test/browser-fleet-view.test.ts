...
test('session summaries prefer the host report and fall back to the client list', () => {
  assert.equal(fleetSessionsHtml({ live: 4, working: 2, waiting: 1, subagents: 1 }, { live: 9, working: 9 }),
    '<div class="fleet-sessions"><strong>4</strong> live · <span class="fleet-working">2 working</span> · 1 waiting on you · 1 subagent</div>');
  assert.equal(fleetSessionsHtml({ live: 0, working: 0, waiting: 0, subagents: 3 }, null),
    '<div class="fleet-sessions"><strong>0</strong> live · 3 subagents</div>');
  assert.equal(fleetSessionsHtml(null, { live: 2, working: 1 }),
    '<div class="fleet-sessions"><strong>2</strong> live · <span class="fleet-working">1 working</span></div>');
