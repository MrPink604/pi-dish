// Generated test/tool from test/browser-session-navigation.test.ts; edit that source and run npm run build:tests.
"use strict";
...
test('session lineage narrows nested identities and decodes the tree recursively', () => {
    const node = (id, children = [], edge = null) => ({ session: { id, name: [], isActive: 'true', subagentLive: 1, lastActivity: false, harnessId: 9, model: {} }, children, edge });
    const mutableChild = node('child', [node('gc')], { kind: 'child', source: {} });
    const wire = {
    ...
    mutableChild.session.id = 'mutated';
