...
async function waitFor<T>(predicate: () => T | null | undefined | false, timeoutMs = 5000): Promise<T> {
...
async function nextStatus(requests: Record<string, unknown>[], from: number, statusKey: string): Promise<{ statusText: string | undefined }> {
