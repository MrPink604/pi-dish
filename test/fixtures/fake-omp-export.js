#!/usr/bin/env node
// Generated test/tool from test/fixtures/fake-omp-export.ts; edit that source and run npm run build:tests.
'use strict';
...
if (exportIndex >= 0) {
    ...
    const header = (0, test_types_js_1.record)(records[0]);
    ...
    const data = {
        ...
        leafId: records.length ? (0, test_types_js_1.record)(records.at(-1)).id || null : null,
