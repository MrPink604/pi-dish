...
Checkpoint 18 migrates fleet advanced search and its facets/results. See
...
| Browser migration | In progress — current stage | Forty-three implementation modules are typed. Most controllers and rendering remain in `public/app.js`. |
...
These forty-three browser implementation modules compile strictly into local
