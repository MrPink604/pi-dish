...
Checkpoint 24 migrates transcript tree rendering and branch navigation. See
...
| Browser migration | In progress — current stage | Fifty-six implementation modules are typed. Most controllers and rendering remain in `public/app.js`. |
...
These fifty-six browser implementation modules compile strictly into local
