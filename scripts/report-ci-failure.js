// Generated tool from scripts/report-ci-failure.ts; edit that source and run npm run build:tools.
"use strict";
...
if (file && fs.existsSync(file)) {
    ...
    const starts = lines.flatMap((line, index) => /[✘✖]|not ok|Error:|Test timeout/.test(line) ? [index] : []);
