...
function createSessionReadHandlers(ports) {
    ...
    const stats = async (req, res) => {
        ...
        try {
            ...
            const { tokens, reasoningTokens, cost, costs, costUnavailable, responseTiming, userMessages, assistantMessages, toolCalls, toolResults, compactions, genMs, genOutput, } = (0, session_files_1.getSessionStats)(source);
