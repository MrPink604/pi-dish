...
function buildActiveSession(live, options) {
    ...
    return {
        ...
        cacheExpiry: (0, cache_lifetime_1.applyLearnedCacheExpiry)(info?.cacheExpiry ?? null),
...
function projectHistory(source, raw, advice, options, liveChild, dirName) {
    ...
    return {
        ...
        cacheExpiry: (0, cache_lifetime_1.applyLearnedCacheExpiry)(info.cacheExpiry), messageCount: info.messageCount || 0, lastActivity: info.lastActivity, isActive: false,
