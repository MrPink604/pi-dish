// Generated from src/core/helper-types.ts; edit that source and run npm run build:core.
...
export interface HelperSession extends Readonly<Pick<SessionFields<Timestamp>, 'name' | 'cwd' | 'model' | 'lastActivity' | 'isActive' | 'turnInProgress' | 'parentId' | 'familyParentId' | 'routine' | 'routineId'>> {
    readonly id: string;
...
export interface SessionQueryTerm {
    readonly neg: boolean;
    readonly field: string | null;
    readonly value: string;
}
export interface SessionQuery {
    terms: SessionQueryTerm[];
    since: number | null;
    before: number | null;
}
export interface RefContextEntry {
    readonly ref: string;
