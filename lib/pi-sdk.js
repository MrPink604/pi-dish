...
// Resolve package paths robustly using CommonJS resolution
...
const SDK_PATH = resolvePackage('@mariozechner/pi-coding-agent');
const CLI_PATH = resolvePackage('@mariozechner/pi-coding-agent/dist/cli.js');
