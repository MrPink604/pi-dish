...
const { fuzzyMatch, fuzzyScore } = require('./helper-query.js');
...
function getDirChildren(inputPath) {
  ...
  try {
    ...
    return { path: resolved, dirs: [], error: e.message };
  }
  const dirs = entries
...
module.exports = { searchFiles, searchHomeDirs, getDirChildren, completePath, isPathCompletionToken, resetCaches };
