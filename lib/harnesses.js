...
const registry = {
  ...
  omp: {
    ...
    // /omfg opens a multi-step generation/save flow; /handoff switches to a
    // new session that the originating web route no longer owns; /hotkeys is
    // a terminal-only keyboard panel; /review is already a prompt command.
    hostBuiltins: [{
      name: 'shake',
