...
const usage_feature_handler_1 = require("./usage-feature-handler");
const cache_lifetime_1 = require("./cache-lifetime");
const skill_feature_handlers_1 = require("./skill-feature-handlers");
const model_feature_handlers_1 = require("./model-feature-handlers");
...
function createFeatureHandlers(ports) {
    ...
    const cacheLifetimes = (_req, res) => {
        res.json({ generatedAt: Date.now(), identities: (0, cache_lifetime_1.cacheLifetimeReport)() });
    };
    ...
    return {
        usageSummary: (0, usage_feature_handler_1.createUsageSummaryHandler)(ports),
        ...(0, skill_feature_handlers_1.createSkillFeatureHandlers)(ports),
        ...(0, model_feature_handlers_1.createModelFeatureHandlers)(ports),
        usageLimits,
        cacheLifetimes,
        settings,
        updateSettings,
