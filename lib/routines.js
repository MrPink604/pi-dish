...
exports.STATUSES = exports.DELIVERIES = exports.ON_BUSY = exports.MODES = exports.THINKING_LEVELS = exports.NAME_RE = exports.MAX_INPUT_BYTES = exports.MAX_SOURCE = exports.MAX_PROMPT = exports.MAX_VERSIONS = exports.MAX_INVOCATIONS = void 0;
...
exports.serializedInputSize = serializedInputSize;
...
function createInvocation(fields = {}) {
    ...
    if (serializedInputSize(input) > exports.MAX_INPUT_BYTES) {
    ...
    const invocation = {
        ...
        source,
        delivery: includes(exports.DELIVERIES, property(fields, 'delivery')) ? property(fields, 'delivery') : 'prompt',
