...
exports.MAX_TTL_MS = exports.MIN_TTL_MS = void 0;
...
const MAX_RULES = 100;
exports.MIN_TTL_MS = 60_000;
exports.MAX_TTL_MS = 365 * 24 * 60 * 60_000;
const cache = new Map();
...
function parseDuration(value) {
    ...
    if (!Number.isSafeInteger(retentionMs) || retentionMs < exports.MIN_TTL_MS || retentionMs > exports.MAX_TTL_MS)
        return null;
