...
export interface CatalogLiveObservation extends Readonly<SessionIdentity> {
    ...
    readonly fields: Readonly<Pick<SessionFields<Date | string | number>, 'name' | 'model' | 'thinkingLevel' | 'contextTokens' | 'contextPercent' | 'contextWindow' | 'messageCount' | 'lastActivity' | 'turnInProgress' | 'askPending' | 'compacting' | 'cwd'>>;
