...
const { parseSessionContent, buildSearchTextFromContent, buildIndexedUsageFromContent } = require('./session-files.js');
...
function scanSessions(files) {
  ...
  for (const file of files) {
    ...
    if (cached && cached.version === META_SCHEMA_VERSION && cached.mtimeMs === stats.mtimeMs && cached.size === stats.size) {
