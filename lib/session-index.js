...
// Pi rate-card revisions. Older entries need their source JSONL reread, so
// the normal bounded backlog rebuilds them like prior upgrades.
const META_SCHEMA_VERSION = 8;
