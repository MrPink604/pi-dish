...
/**
 * Production lifecycle dependencies are methods of the checked operation owner.
 * This JS runner remains unchecked; these imports document the generated boundary,
 * not a second implementation of admission, fallback, or close authority.
 * @param {object} deps
 * @param {import('./session-operations').SessionOperations['createSession']} deps.createSession
 * @param {import('./session-operations').SessionOperations['resumeSessionById']} deps.resumeSession
 * @param {import('./session-operations').SessionOperations['closeSessionById']} deps.closeSession
 */
